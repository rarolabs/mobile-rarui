...
class ExampleMaterialComponent extends StatelessWidget
    with Component<ExampleMaterialStyle, ExampleMaterialSharedStyle> {
  /// Responsável por definir o comportamento do componente
  final Behaviour behaviour;

  /// Responsável por definir o estilo do componente
  final ExampleMaterialStyleSet styles;
  ...
  const ExampleMaterialComponent({
    super.key,
  ...
  @override
  Widget whenLoading(
    ExampleMaterialStyle style,
    ExampleMaterialSharedStyle otherStyle,
    BuildContext context,
    Behaviour childBehaviour,
  ) =>
      _BaseExampleMaterial(
        behaviour: behaviour,
        style: style,
...
class _BaseExampleMaterial extends StatelessWidget {
  final Behaviour behaviour;
  final ExampleMaterialStyle style;
  final String? semanticsLabel;
  final String? semanticsHint;
