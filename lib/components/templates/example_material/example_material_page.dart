        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              _buildButtonRow(context, Theme.of(context).extension<ExtraColors>()!.success, () {}),
              _buildButtonRow(context, Theme.of(context).extension<ExtraColors>()!.warning, () {}),
              _buildButtonRow(context, Theme.of(context).extension<ExtraColors>()!.error, () {}),
              const SizedBox(height: 20),
              ...
              const SizedBox(height: 20),
              _buildToggleableWidgets(context, Theme.of(context).extension<ExtraColors>()!.success),
              _buildToggleableWidgets(context, Theme.of(context).extension<ExtraColors>()!.warning),
              _buildToggleableWidgets(context, Theme.of(context).extension<ExtraColors>()!.error),
            ],
          ),
        ),
      ),
