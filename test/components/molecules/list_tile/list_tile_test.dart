...
void main() {
  testWidgets('RListTile: deve renderizar corretamente as propriedades passadas', (tester) async {
    const leading = Text('leading');
    // iniciando widget

    await tester.pumpWidget(MaterialApp(home: Scaffold(body: RListTile(leading: leading))));
