...
void main() {
  testWidgets('RTitleSubtitle exibe título e subtítulo corretamente', (WidgetTester tester) async {
    const title = 'Título de Teste';
    const subTitle = 'Subtítulo de Teste';
    const spaceBetween = 8.0;

    await tester.pumpWidget(const MaterialApp(
      home: Scaffold(body: RTitleSubtitle(title: title, subTitle: subTitle, spaceBetween: spaceBetween)),
    ));
